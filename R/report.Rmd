...
## §2 Inzidenz späte AMD (Definition 1)
...
```
## §3 Inzidenz späte AMD (Definition 2)
...
```
## § Progression späte AMD (von keiner AMD)
...
```
\newpage
# II Logistische Modelle Continental Score FIT

## §1 Inzidenz fruehe AMD
```{r}
```

## §2 Inzidenz spaete AMD
```{r}
```