...
get_table_glm(model_glm_fit_1, expo = FALSE) %>% 
...
get_table_glm(model_glm_fit_2, expo = FALSE) %>% 
...
get_table_glm(model_glm_ff4_1, expo = FALSE) %>% 
  my_kable(caption = "Risikofaktoren frühe AMD", col.names = NA)
```
...
get_table_glm(model_glm_ff4_2, expo = FALSE) %>% 
  my_kable(caption = "Risikofaktoren späte AMD (Def. 2)", col.names = NA)
```
